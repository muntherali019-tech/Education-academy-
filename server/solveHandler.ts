 ...
 */
export function handleSolveRequest(raw: unknown, solver: Solver): Promise<HandlerResponse> {
  return handlePhotoRequest(raw, solver, "Mochi could not solve that problem. Please try again.");
}
